...
export default function CrewPage() {
  ...
  <section className="pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {oldCrew.length > 0 && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-orange-400 mb-6">Old Crew</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 bg-gray-800 overflow-hidden">
        ...
        >
          <motion.span 
            className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${domainColors[member.domain as keyof typeof domainColors]} text-white relative overflow-hidden`}
            whileHover={{ boxShadow: '0 0 15px rgba(249, 115, 22, 0.5)' }}
          >
            <motion.span
      ...
      <div className="p-6 relative">
        ...
        <motion.h3 
          ...
          whileHover={{ x: 5, textShadow: '0 0 10px rgba(255, 255, 255, 0.3)' }}
        >
          {member.name}
        </motion.h3>
        <motion.p 
